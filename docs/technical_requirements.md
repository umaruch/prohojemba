...
Для начала продублировать функционал google таблицы
...
# 10. Описание таблиц базы данных
users = данные об аккаунте и все необходимое для авторизации:
- id
- email
- password_hash

profiles - пользовательский профиль аккаунта:
- id
- username
- avatar_path
- steam_id
...
## TODO
Возможно в будущем стоит добавить чаты с личными сообщениями