...
# 3. Планирование активностей
Пока на уровне концепции.

Для реализации планирования добавить элементам свойство, представляющее из себя текстовую переменную (state).
- Возможные состояния:
...
При планировании должны быть запрошены следующие поля:
- title_id
- state
...
# 6. Требования к Discord боту (раздел постановки в состоянии доработки)
